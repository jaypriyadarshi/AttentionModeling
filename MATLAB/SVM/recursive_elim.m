...
feat_name = {'sacc1_C_h1','sacc1_C_h2', 'sacc1_C_h3', 'sacc1_F_h1','sacc1_F_h2', 'sacc1_F_h3', 'sacc1_I_h1','sacc1_I_h2', 'sacc1_I_h3','sacc1_M_h1','sacc1_M_h2', 'sacc1_M_h3','sacc1_O_h1','sacc1_O_h2', 'sacc1_O_h3','sacc2_C_h1','sacc2_C_h2', 'sacc2_C_h3', 'sacc2_F_h1','sacc2_F_h2', 'sacc2_F_h3', 'sacc2_I_h1','sacc2_I_h2', 'sacc2_I_h3','sacc_a_M_h1','sacc2_M_h2', 'sacc2_M_h3','sacc2_O_h1','sacc2_O_h2', 'sacc2_O_h3','sacc_a_C_h1','sacc_a_C_h2', 'sacc_a_C_h3', 'sacc_a_F_h1','sacc_a_F_h2', 'sacc_a_F_h3', 'sacc_a_I_h1','sacc_a_I_h2', 'sacc_a_I_h3','sacc_a_M_h1','sacc_a_M_h2', 'sacc_a_M_h3','sacc_a_O_h1','sacc_a_O_h2', 'sacc_a_O_h3','sac1_pvel_h1', 'sac1_pvel_h2', 'sac1_pvel_h3','sac1_amp_h1', 'sac1_amp_h2', 'sac1_amp_h3','sac1_ang_h1', 'sac1_ang_h2', 'sac1_ang_h3','sac1_dx_h1', 'sac1_dx_h2', 'sac1_dx_h3','sac1_dy_h1', 'sac1_dy_h2', 'sac1_dy_h3','sac1_dur_h1', 'sac1_dur_h2', 'sac1_dur_h3','sac2_pvel_h1', 'sac2_pvel_h2', 'sac2_pvel_h3','sac2_amp_h1', 'sac2_amp_h2', 'sac2_amp_h3','sac2_ang_h1', 'sac2_ang_h2', 'sac2_ang_h3','sac2_dx_h1', 'sac2_dx_h2', 'sac2_dx_h3','sac2_dy_h1', 'sac2_dy_h2', 'sac2_dy_h3','sac2_dur_h1', 'sac2_dur_h2', 'sac2_dur_h3','sac_a_pvel_h1', 'sac_a_pvel_h2', 'sac_a_pvel_h3','sac_a_amp_h1', 'sac_a_amp_h2', 'sac_a_amp_h3','sac_a_ang_h1', 'sac_a_ang_h2', 'sac_a_ang_h3','sac_a_dx_h1', 'sac_a_dx_h2', 'sac_a_dx_h3','sac_a_dy_h1', 'sac_a_dy_h2', 'sac_a_dy_h3','sac_a_dur_h1', 'sac_a_dur_h2', 'sac_a_dur_h3'};
%save('feat_names.mat','feat_name');
...
[dim1, n_feats] = size(train_feats_shuff);
count = 1;
while n_feats > 1
    model = svmtrain(train_labels_shuff, train_feats_shuff, '-s 0 -t 0 -c 10');
    ...
    weights = model.sv_coef' * full(model.SVs);
    min_idx = find(weights == min(weights));
    if count == 1
        [~, elim_order] = sort(weights);
        count = count + 1;
    end
    train_feats_shuff = horzcat(train_feats_shuff(:, 1:min_idx - 1), train_feats_shuff(:,min_idx + 1:end));
    test_feats_shuff = horzcat(test_feats_shuff(:, 1:min_idx - 1), test_feats_shuff(:,min_idx + 1:end));
    [dim1, n_feats] = size(train_feats_shuff);
end
figure
plot(1: length(accuracies), accuracies)
feat_order = feat_name(elim_order);